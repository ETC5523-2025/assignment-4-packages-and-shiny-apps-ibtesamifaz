...
<!-- badges: start -->
[![pkgdown site](https://img.shields.io/badge/docs-pkgdown-blue.svg)](https://etc5523-2025.github.io/assignment-4-packages-and-shiny-apps-ibtesamifaz/deltaq/)
<!-- badges: end -->
...
📊 **Dataset** — Simulated quarantine breaches, overseas cases,
and arrivals across Australian states between 27 October 2020 and 22
April 2021.  
💡 **Shiny app** — An interactive tool that allows users to
explore outbreak data, visualize state differences, and simulate
quarantine scenarios.  
📚 **Documentation** — Full reproducible examples and reference pages available at  
👉 [**deltaq documentation site**](https://etc5523-2025.github.io/assignment-4-packages-and-shiny-apps-ibtesamifaz/deltaq/)
...
simulation outputs from Zachreson et al. (2022),
Model-informed risk assessment for COVID-19 quarantine systems under the Delta variant.
